                        ...
                        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            {!isMobile && (
                                <div style={{ display: 'flex', gap: '2rem' }}>
                                    ...
                                    <button onClick={() => window.open('https://calendly.com/manish-gensync/30min', '_blank', 'noopener,noreferrer')} style={{ color: '#fff', fontSize: '0.9rem' }}>Talk through your idea</button>
                                </div>
                            )}
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    ...
                    >
                        ...
                        <button onClick={() => window.open('https://calendly.com/manish-gensync/30min', '_blank', 'noopener,noreferrer')} style={{ color: '#fff', fontSize: '1.5rem', fontFamily: 'var(--font-heading)' }}>Talk through your idea</button>
                    </motion.div>
                )}
            </AnimatePresence>
        </>
